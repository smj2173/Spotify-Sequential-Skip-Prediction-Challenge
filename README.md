...
Despite the many features and offerings of Spotify’s streaming service, instances of users skip- ping songs raise questions about how this “implicit feedback signal” reflects user satisfaction and future engagement with the streaming service (Meggetto et al., 2021). Spotify’s algorithms and song recommendations should be curated to users’ personal tastes that they don’t need to skip songs. We intend to examine the specifics of the user ex- perience on the mobile Spotify application from publicly available datasets of users skipping songs.
